...
from gaussian_initiailization.stage2.experiment_provenance import write_experiment_bundle
...
def main() -> None:
    ...
    if args.initial_state_json is not None:
        ...
        from gaussian_initiailization.stage2.initial_state_estimation import estimate_initial_state_from_images
