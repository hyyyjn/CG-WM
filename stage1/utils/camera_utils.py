...
from stage1.scene.cameras import Camera
import numpy as np
from stage1.utils.graphics_utils import fov2focal
...
def loadCam(args, id, cam_info, resolution_scale, is_nerf_synthetic, is_test_dataset):
    ...
    sam_feature_map = None
    if cam_info.sam_feature_path != "" and os.path.exists(cam_info.sam_feature_path):
        try:
            sam_feature_map = np.load(cam_info.sam_feature_path).astype(np.float32)
        except Exception as e:
